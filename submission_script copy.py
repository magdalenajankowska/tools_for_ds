...
columns_without_2500_non_nulls = weather_df.notnull().sum()[weather_df.notnull().sum() <= 2500].index
weather_df.drop(columns=columns_without_2500_non_nulls, inplace=True)
